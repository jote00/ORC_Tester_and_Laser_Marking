Module Declaration
    ...
    Public ADDR_STN3_CYL1 As Integer
    Public ADDR_STN3_CYL2 As Integer
    Public ADDR_STN3_CYL3 As Integer
    Public ADDR_STN3_CYL4 As Integer
    ...
    Public ADDR_STN4_CYL1 As Integer

    Public STN4_CYL1 As Integer = 0
    Public LAST_STN4_CYL1 As Integer = 0

    Public ADDR_STN5_CYL1 As Integer
    Public ADDR_STN5_CYL2 As Integer
    Public ADDR_STN5_CYL3 As Integer
    ...
    Public ADDR_STN6_CYL1 As Integer
    Public ADDR_STN6_CYL2 As Integer
    Public ADDR_STN6_CYL3 As Integer
    ...
    Public ADDR_STN3_SEN3 As Integer
    Public ADDR_STN3_SEN4 As Integer

    Public ADDR_STN4_SEN1 As Integer

    Public ADDR_STN5_SEN1 As Integer
    Public ADDR_STN5_SEN2 As Integer
    Public ADDR_STN5_SEN3 As Integer

    Public ADDR_STN6_SEN1 As Integer
    Public ADDR_STN6_SEN2 As Integer
    Public ADDR_STN6_SEN3 As Integer
